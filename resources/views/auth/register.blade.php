    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-6">
            <div class="panel panel-default mt-4">
                <h3 class="panel-heading">Registro</h3>
                ...
                <div class="panel-body">
                    ...
                    <input type="hidden" name="ciudad" value="0">
                        ...
                        <div class="form-group{{ $errors->has('ciudad') ? ' has-error' : '' }}">
                            <label for="ciudad" class="col-md-12 control-label">Ciudad</label>

                            <div class="col-md-12">

                                <input id="localidad" type="localidad" class="form-control" name="localidad" value="{{ old('localidad') }}" required>
                        ...
                        <div class="form-group">
                            <label for="password-confirm" class="col-md-12 control-label">Confirme su Contraseña</label>
